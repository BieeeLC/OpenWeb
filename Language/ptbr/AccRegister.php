...
/************************************************\
* X-Team Mu Web Acc Register Language File.		 *
* Becareful with this settings!          		 *
\************************************************/

//Please take care with [tags]. It means dinamic data!
//[verify_hash], [memb___id], etc.
...
$AccRegister05 = "São necessários 7 NÚMEROS para a chave secreta";
...
$AccRegister15 = "MuCyber Season 4 - Cadastro!"; //Mail Confirmation Subject

//Mail Confirmation Content (html enabled)

$AccRegister16 = "<p>Ol&aacute;, [memb_name]!</p><p>Você registrou-se recentemente no MuCyber.</p><p>Para ativar sua conta, é necessário que você abra o link abaixo em seu navegador:<br />http://www.mucyber.com.br/?c=MailActivate/[verify_hash]/[memb___id]<br /><a href='http://www.mucyber.com.br/?c=MailActivate/[verify_hash]/[memb___id]'>ATIVAR CONTA</a></p><p>Lembrando seus dados:<br />Nome de Usuário: [memb___id]<br />Senha: (oculta) <br />E-mail: [mail_addr] <br />Pergunta Secreta: [fpas_ques] <br />Resposta Secreta: [fpas_answ] <br /><b>NÃO ESQUEÇA SEUS DADOS, PRINCIPALMENTE SUA SENHA!<br />É A ÚNICA FORMA DE MANTER SUA CONTA SEMPRE ATIVA E SEGURA!</b><br /><br />

<p>Agradecemos a preferência,</p><p>Equipe MuCyber</p><p>* Esta mensagem foi gerada automaticamente em nossos servidores, por favor não responda.</p>";
?>
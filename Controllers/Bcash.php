...
if(file_exists($_SERVER['DOCUMENT_ROOT'] . "/" . $_SESSION['SiteFolder'] . "Templates/$MainTemplate/Bcash.tpl.php"))
{
	...
	$tpl = new Template;
	$tpl->Assign($my_array);
	$tpl->Display($_SERVER['DOCUMENT_ROOT'] . "/" . $_SESSION['SiteFolder'] . "Templates/$MainTemplate/Bcash.tpl.php");
}
else
{
	echo "ERROR: File Templates/$MainTemplate/Bcash.tpl.php doesnt exists";
}
